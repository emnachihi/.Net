...
namespace AM.ApplicationCore.Domain
{
    public static class TestData
    {
        ...
        // Staffs
        public static Staff captain = new Staff { FullName = new FullName { FirstName = "captain", LastName = "captain" }, EmailAdress = "captain.captain@gmail.com", BirthDate = new DateTime(1965, 01, 01), EmployementDate = new DateTime(1999, 01, 01), Salary = 99999 };
        public static Staff hostess1 = new Staff { FullName = new FullName { FirstName = "hostess1", LastName = "hostess1" }, EmailAdress = "hostess1.hostess1@gmail.com", BirthDate = new DateTime(1995, 01, 01), EmployementDate = new DateTime(2020, 01, 01), Salary = 999 };
        public static Staff hostess2 = new Staff { FullName = new FullName { FirstName = "hostess2", LastName = "hostess2" }, EmailAdress = "hostess2.hostess2@gmail.com", BirthDate = new DateTime(1996, 01, 01), EmployementDate = new DateTime(2020, 01, 01), Salary = 999 };
        // Travellers
        ...
        public static Traveller traveller2 = new Traveller { FullName = new FullName { FirstName = "traveller2", LastName = "traveller2" }, EmailAdress = "traveller3.traveller3@gmail.com", BirthDate = new DateTime(1982, 01, 01), HealthInformation = "no troubles", Nationality = "Tunisian" };
        public static Traveller traveller3 = new Traveller { FullName = new FullName { FirstName = "traveller1", LastName = "traveller1" }, EmailAdress = "traveller4.traveller4@gmail.com", BirthDate = new DateTime(1983, 01, 01), HealthInformation = "Some troubles", Nationality = "American" };
        public static Traveller traveller4 = new Traveller { FullName = new FullName { FirstName = "traveller1", LastName = "traveller1" }, EmailAdress = "traveller5.traveller5@gmail.com", BirthDate = new DateTime(1984, 01, 01), HealthInformation = "Some troubles", Nationality = "Spanish" };
        // Flights
        ...
        public static Flight flight1 = new Flight
        {
            ...
            passengers = new List<Passenger> { captain, hostess1, hostess2, traveller1, traveller2, traveller3, traveller4,  }
       ,
            plane = Airbusplane
        };
